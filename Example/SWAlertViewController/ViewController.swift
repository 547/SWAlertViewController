...
//        let alert = CFAlertViewController.init(title: "test", message: "this is message", titleFont: UIFont.systemFont(ofSize: 17), messageFont: UIFont.systemFont(ofSize: 15), titleAndMessageSpace: 18, textAlignment: .center, margin: 18, cornerRadius: 8, borderColor: nil, borderWidth: nil, preferredStyle: .alert, actionsArrangement: .horizontal, didDismissAlertHandler: nil)
        ...
        let alert = CFAlertViewController.init(title: "test", titleColor: UIColor.black, message: "this is message", messageColor: UIColor.gray, titleFont: UIFont.systemFont(ofSize: 12), messageFont: UIFont.systemFont(ofSize: 9), titleAndMessageSpace: 11, textAlignment: .center, separationLineColor: UIColor.gray.withAlphaComponent(0.3), separationLineLeading: 0, separationLineTrailing: 0, textContentBottomMargin: 24, separationLineHeight: 0.5, margin: 30, cornerRadius: 8, borderColor: nil, borderWidth: 0, actionsLeading: 46, actionsTrailing: 46, actionsTop: 18, actionsBottom: 18, actionsSpace: 18, actionsHeight: 30, preferredStyle: .alert, actionsArrangement: .horizontal, headerView: nil, footerView: nil, didDismissAlertHandler: nil)
